...
%>
	<div style="width: 100%; height: 20px; float: right;">
		<input type="button" onclick="window.location.href='Login.jsp'"
			value="返回" style="float: right;"> <a
			style="float: right; font-weight: 600;"><%=name%></a>
	</div>
	<div>
